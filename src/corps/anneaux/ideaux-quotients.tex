...
\subsection{Relations} Tout morphisme $\phi:A\rightarrow B$  d'anneaux commutatifs induit une application $\phi^{-1}: (\mathcal{I}_B,\subset)\rightarrow (\mathcal{I}_A,\subset)$ préservant $\subset$.  De plus, si $I\in \mathcal{I}_B$, le noyau de
