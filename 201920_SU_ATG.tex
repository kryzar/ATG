...
\begin{remarque}La notion de suite exacte est au coeur de l'étude de la structure des $A$-module. La raison première est que c'est l'outil qui permet de 'dévisser' un $A$-module compliqué ($M$) en deux $A$-modules plus simples ($M'$ et $M''$).\\
...
\end{enumerate}
Les suites exactes courtes sont-elles scindées ? Que se passe-t-il ? Même question si l'on remplace $\Z$ par $\Q$
