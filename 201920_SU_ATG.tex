...
\begin{definition}[Extension des scalaires par un quotient] Soit $M$ un $A$-module et $I\subset A$ un idéal. Notons $IM\subset M$ le sous-$A$-module engendré par les éléments de la forme $am$, $a\in I$, $m\in M$. Par propriété universelle du quotient, l'application $$\begin{tabular}[t]{clc}
