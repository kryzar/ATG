...
>>>>>>> 4897ffbcff5a22654377bf0d47974e202ef5b1f2
...
\item Pour $I\subset A$ un idéal, on a 
	$$\iota_S^{-1}S^{-1}I=\left\{ a\in A\;|\; \frac{a}{1} \in S^{-1}I\right\}= \{a\in A\;|\;  Sa\cap I\not=\varnothing\rbrace=\bigcup_{s\in S}(s\cdot)^{-1}I.$$
...
\subsection{}\label{LocIdeaux}\textbf{Lemme.} \textit{L'application $S^{-1}:(\mathcal{I}_A,\subset)\rightarrow (\mathcal{I}_{S^{-1}A},\subset) $ est surjective, croissante pour $\subset$ et se restreint en une surjection    $$S^{-1}:\lbrace I\in\mathcal{I}_A\;|\; I\cap S=\varnothing\rbrace \twoheadrightarrow  \mathcal{I}_{S^{-1}A}\setminus \lbrace S^{-1}A\rbrace . $$
...
<<<<<<< HEAD
$$\xymatrix{spec(S^{-1}A) \ar@<1ex>[r]^{\iota_S^{-1}}& \lbrace \frak{p}\in spec(A)\;|\; \frak{p}\cap S=\varnothing\rbrace \ar@<1ex>[l]^{S^{-1}} }$$} 
